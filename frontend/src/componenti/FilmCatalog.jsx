...
const FilmCatalog = () => {
  ...
  return (
    <div className="film-catalog">
      ...
      {/* Pezzo di codice da sitemare perche non fa piu aggiungere film 
      <div className="catalog-controls">
        ...
        <button className="add-btn" onClick={() => setIsAdding(true)}>
          <i className="fas fa-plus"></i> Aggiungi Film
        </button>
      </div>
      ...
      {isAdding && (
        <div className="film-form">
          ...
          <div className="form-actions">
            <button className="save-btn" onClick={handleAddFilm}>Salva</button>
            <button className="cancel-btn" onClick={() => setIsAdding(false)}>Annulla</button>
          </div>
        </div>
      )}
